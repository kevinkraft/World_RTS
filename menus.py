...
class menu(object):
    ...
    def draw_menu(self, tile_height, tile_width, screen, tiles_per_side, menu_draw_factor):
...
class tile_menu(menu):
    ...
    def __init__(self, tile, menu_scale, menu_width = 0, menu_height = 0):
        menu.__init__(self, tile)
        self.menu_scale = menu_scale
        print self.menu_scale
